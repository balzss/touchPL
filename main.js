...
The code transformation is done by parsing the js code to an abstract syntax tree (AST). I'm using <a href="#">acorn</a> to that but it should work fine with every <a href="#">estree</a> compatible parser.</p>
<p>The generated AST is a list of js objects wich is given to a <a href="#">vue.js</a> app that I created custom components for to generate HTML based on the nodes. After that it's just the matter of CSS to have it displayed the way I want.</p>
...
<li><a href="#">ace editor</a> for the code editor on the demo page</li>
<li><a href="#">acorn</a> for the js to ast generation</li>
<li><a href="#">vue.js</a> for generation HTML from the AST</li>
<li>I also used quite extensively the <a href="#">astexplorer</a> to help me construct the AST -> HTML bit of the app</li>
</ul></p>`;
